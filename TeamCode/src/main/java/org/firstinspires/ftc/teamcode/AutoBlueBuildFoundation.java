...
public class AutoBlueBuildFoundation extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        moveThatRobot(36, -24, -24, 36, 0.7, 1000, 6000);
        moveThatRobot(2,2,2,2,0.5,300,4000);
        robot.tail.setPosition(robot.TAIL_DOWN);
        sleep(4000);
        moveThatRobot(34, 34, 34, 34, 1, 1000, 6000);
        robot.tail.setPosition(robot.TAIL_UP);
        moveThatRobot(-70,70,70,-70,0.7,1000,15000);
        //rotateRobot(75, 0.7);
